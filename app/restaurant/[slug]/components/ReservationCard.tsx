...
const ReservationCard = ({
  ...
  const handleChangePartySize = (e: React.ChangeEvent<HTMLSelectElement>) => {
  ...
  return (
    <div className="fixed w-full bottom-0 md:bottom-auto md:w-[35%] md:max-w-sm bg-white rounded p-3 shadow">
          ...
          <div className="flex flex-wrap mt-2">
            {data.map((t) =>
              t.available ? (
                ...
                <p
                  key={t.time}
                  className="bg-gray-300 p-4 w-24 mb-3 rounded mr-3"
                ></p>
              )
            )}
          </div>
